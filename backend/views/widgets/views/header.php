...
<header class="app-header navbar">
    ...
    <ul class="nav navbar-nav d-md-down-none mr-auto">
        <li class="nav-item px-3">
            <a class="nav-link" href="#"><?= Yii::t('backend', 'dashboard') ?></a>
        </li>
        <li class="nav-item px-3">
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="#"><i class="fa fa-envelope-o"></i> <?= Yii::t('backend', 'messages') ?><span class="badge badge-success">42</span></a>
                ...
                <a class="dropdown-item" href="<?= Url::to(['auth/logout']) ?>" data-method="POST"><i class="fa fa-lock"></i> <?= Yii::t( 'backend', 'logout') ?></a>
            </div>
        </li>
